...
class TerminalApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.btn_toggle_view.setStyleSheet("background-color: #008CBA; color: black; font-weight: bold; padding: 6px; border-radius: 4px;")
        ...
        self.btn_toggle_log.setStyleSheet("background-color: #3f51b5; color: black; font-weight: bold; padding: 5px;")
    ...
    def setup_log_panel(self):
        ...
        self.btn_log_start_stop.setStyleSheet("background-color: #4CAF50; color: black; font-weight: bold;")
        self.btn_log_start_stop.clicked.connect(self.toggle_logging)
        
        self.btn_log_finish = QPushButton("Finish", self)
        self.btn_log_finish.setStyleSheet("background-color: #f44336; color: black; font-weight: bold;")
    ...
    def toggle_center_view(self):
        ...
        if self.ui.plainTextEdit.isHidden():
            ...
            self.btn_toggle_view.setStyleSheet("background-color: #E65100; color: black; font-weight: bold; padding: 6px; border-radius: 4px;")
        else:
            self.ui.plainTextEdit.hide()
    ...
    def toggle_logging(self):
        ...
        if not self.is_logging:
            ...
            self.btn_log_start_stop.setStyleSheet("background-color: #FF9800; color: black; font-weight: bold;")
